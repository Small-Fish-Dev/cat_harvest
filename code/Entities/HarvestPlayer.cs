...
{
    [Library]
    public partial class HarvestWalkController : BasePlayerController
    {
    ...
    [Net, Predicted] public PawnController Controller { get; set; } = null;
    ...
    public override void Spawn()
    {
        ...
        Controller = new HarvestWalkController() { WalkSpeed = 100.0f, DefaultSpeed = 100.0f, SprintSpeed = 160.0f };
    ...
    public override void Simulate(IClient cl)
    {
        ...
        var tracePosition = Position + Controller?.EyeLocalPosition ?? Vector3.Zero;
        var traceDirection = Rotation.Forward;

        var eyeTraceSetup = Trace.Ray(tracePosition, traceDirection)
        ...
        {
            //DebugOverlay.TraceResult(eyeTrace, 10);
            DebugOverlay.Line(eyeTrace.StartPosition, eyeTrace.StartPosition + eyeTrace.Direction * 30, 10f);
            DebugOverlay.Sphere(eyeTrace.StartPosition + eyeTrace.Direction * 30, 20f, Color.Blue, 10f, false);
            //Log.Info($"{eyeTrace.EndPosition} {eyeTrace.Direction} {eyeTrace.Normal}");

            /*var arrow = new ModelEntity()
            {
                Model = Model.Load("models/light_arrow.vmdl"),
    ...
    public override void FrameSimulate(IClient cl)
    {
        ...
        Camera.Position = Position + Controller.EyeLocalPosition;
